...
def main():
    ...
    parser.add_argument("--bot-url",       required=True, help="Public URL of gitlab-issue-bot")
    parser.add_argument("--solver-url",    required=True, help="Public URL of gitlab-issue-solver")
